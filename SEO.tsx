    ...
    <div className="relative group w-full cursor-pointer">
      ...
      >
        ...
        <button 
          ...
          className="absolute top-2 left-2 z-20 p-2 rounded-full bg-black/40 backdrop-blur-md border border-white/10 text-white hover:bg-brand-primary transition-all active:scale-95 group/heart"
        >
          <Heart 
            size={16} 
